...
async function main() {
  ...
  await prisma.prompt.create({
    data: {
      ...
      description: `Seu papel é gerar três títulos para um vídeo do YouTube.
...
'''`.trim()
  ...
  await prisma.prompt.create({
    data: {
      ...
      description: `Seu papel é gerar uma descrição sucinta para um vídeo do YouTube.
...
await prisma.prompt.create({
  data: {
    ...
    description: `Gere um código em NOME_DA_LINGUAGEM com base na transcrição do video abaixo:
